              ...
              children: <Widget>[
                        ...
                        text: TextSpan(
                            ...
                            children: [
                              ...
                              TextSpan(
                                  text: 'USERNAME',
                                  style:
                                      TextStyle(color: colors.withName('pink')))
                            ]),
                      ),
                      TextField(
                        ...
                        style:
                            GoogleFonts.getFont('Chelsea Market', fontSize: 18),
                ...
                Container(
                  ...
                  child: IconButton(
                    iconSize: 50,
                    onPressed: () {
                      var state = context.bloc<SignupBloc>().state;
                      if (state is SignupAvatarSet) {
                        context.bloc<SignupBloc>().add(Signup(
                            user: new User(_username.text, state.avatar)));
                      }
                    },
                    icon: Icon(
                      Icons.chevron_right,
